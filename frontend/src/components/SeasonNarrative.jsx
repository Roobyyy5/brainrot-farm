    ...
    <div className="season-narrative" style={{ background: gradient }}>
      <div className="sn-top" onClick={() => setExpanded(e => !e)}>
        ...
        <div className="sn-main">
          <div className="sn-season">Season {seasonNum}</div>
          <div className="sn-name">{current.name}</div>
        </div>
        <div className="sn-mybp">
          <div className="sn-mybp-label">Your BP</div>
        ...
        <div className="sn-expanded">
          ...
          {current.mechanic !== 'standard' && (
            <div className="sn-mechanic">
              {current.mechanic === 'double_crits' && <span>⚡ Season Mechanic: <b>Crits ×2 | Boss HP ×3</b></span>}
              {current.mechanic === 'artifact_boost' && <span>⚡ Season Mechanic: <b>Artifact drops ×2 | BP ×1.5</b></span>}
              {current.mechanic === 'energy_drain' && <span>⚡ Season Mechanic: <b>Energy drain ×2 | BP ×2</b></span>}
            </div>
          )}

          <div className="sn-leaderboard">
            <div className="sn-lb-title">🏆 Season Leaders</div>
            {topPlayers.map(p => (
          ...
          {next && (
            <div className="sn-next">
              <span className="sn-next-label">Next Season:</span>
