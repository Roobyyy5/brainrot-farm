...
const STATIC: Record<string, unknown> = {
  ...
  uk: {
    nav: { feed: "Стрічка", search: "Пошук", economy: "Економіка", messages: "Повідомлення", wallet: "Гаманець", leaderboard: "Рейтинг", notifications: "Сповіщення", profile: "Профіль", settings: "Налаштування", rewards: "Нагороди", news: "Крипто Новини", governance: "Управління", bookmarks: "Закладки" },
    ...
    profile: { follow: "Стежити", unfollow: "Відписатись", followers: "Підписники", following: "Підписки", posts: "Пости", progress: "Прогрес", brainPoints: "Brain Points", loginStreak: "Серія входів", reputation: "Репутація", noBio: "Немає біо.", noPosts: "Постів ще немає.", loadMore: "Завантажити ще", repHistory: "Історія репутації", longestStreak: "Найдовша", toNextMilestone: "{{days}}д до наступного рубежу" },
  ...
  ru: {
    nav: { feed: "Лента", search: "Поиск", economy: "Экономика", messages: "Сообщения", wallet: "Кошелёк", leaderboard: "Рейтинг", notifications: "Уведомления", profile: "Профиль", settings: "Настройки", rewards: "Награды", news: "Крипто Новости", governance: "Управление", bookmarks: "Закладки" },
    ...
    profile: { follow: "Подписаться", unfollow: "Отписаться", followers: "Подписчики", following: "Подписки", posts: "Посты", progress: "Прогресс", brainPoints: "Brain Points", loginStreak: "Серия входов", reputation: "Репутация", noBio: "Биo не заполнено.", noPosts: "Постов пока нет.", loadMore: "Загрузить ещё", repHistory: "История репутации", longestStreak: "Наибольшая", toNextMilestone: "{{days}}д до следующей отметки" },
